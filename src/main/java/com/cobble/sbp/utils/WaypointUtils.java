...
public class WaypointUtils {
    ...
    public static void drawCube(double wpX, double wpY, double wpZ, double wpW, double xOff, double yOff, double zOff, Color c, RenderWorldLastEvent event) {
        ...
        //Utils.sendMessage("Cube: ["+wpX+", "+wpY+", "+wpZ+"]");
        WaypointUtils.drawFilledBoundingBox(x+xOff, y+yOff, z+zOff, x+wpW+xOff, y+wpW+yOff, z+wpW+zOff, c, 1);
        GlStateManager.disableLighting();
        GlStateManager.enableCull();
    ...
    public static void renderWaypoint(String wpN, double wpX, double wpY, double wpZ, Color wpC, RenderWorldLastEvent event) {
        ...
        GlStateManager.enableLighting();
        GlStateManager.disableTexture2D();
        WaypointUtils.renderBeaconBeam(x, y+1, z, wpC.getRGB(), 1, event.partialTicks);

        WaypointUtils.renderWaypointText(wpN, pos.up(2), event.partialTicks);
        GlStateManager.disableLighting();
        GlStateManager.enableTexture2D();
        GlStateManager.enableCull();
        GlStateManager.enableDepth();

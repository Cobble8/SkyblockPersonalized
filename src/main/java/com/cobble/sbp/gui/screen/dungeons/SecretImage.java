...
public class SecretImage extends Gui {
	...
	public static int imgHeight = 101*DataGetter.findInt("dungeon.secretImage.size")/10;
	public static int imgWidth = 192*DataGetter.findInt("dungeon.secretImage.size")/10;
	public static int imgX = DataGetter.findInt("dungeon.secretImage.x");
	public static int imgY = DataGetter.findInt("dungeon.secretImage.y");
	public static String bgColorID = DataGetter.findStr("dungeon.secretImage.bgColor");
	public static String scrtColorID = DataGetter.findStr("dungeon.secretImage.textColor");
	...
	public SecretImage() {
		...
		try {
			int scale = DataGetter.findInt("dungeon.secretImage.size");

...
public class SettingList {
	...
	public static void loadSettings() {
		...
		h.addSetting("Pickaxe Ability Timer", "dwarven", "pickReminderToggle", "Show on screen how long until your pickaxe ability is available", "moveGUI: 50;16, textColor, textColor, boolean, boolean, color", "Move Location, Default Text Color, Active Text Color, Only Show in Dwarven Mines, Only Show When Holding Pickaxe, Bar Color", "pickTimer, pickTimerTextColor, pickActiveTimerTextColor, pickTimerDwarven, pickTimerHolding, pickTimerBarColor");

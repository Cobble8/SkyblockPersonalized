...
public class SetImageDelay extends GuiScreen {
	...
	public void initGui() {
	    ...
	    this.inputNum = new GuiTextField(11, this.fontRendererObj, this.width/2-20, this.height/2, 40, 20);
	    this.inputNum.setText("");
		this.inputNum.setMaxStringLength(5);
	  ...
	  protected void keyTyped(char par1, int par2) throws IOException
	    {
	        ...
	        if(par2==Keyboard.KEY_RETURN && this.inputNum.isFocused()) {
	        	...
	        	if(Utils.isNumeric(this.inputNum.getText())) {
	        		this.inputNum.setFocused(false);
	        		ConfigHandler.newObject("imageDelay", Integer.parseInt(this.inputNum.getText()));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		mc.fontRendererObj.drawString(ChatFormatting.AQUA+"Please enter the amount of seconds you want the image to stay on screen below:", this.width/2-200, this.height/2-12, 0x10, true);
